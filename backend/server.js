...
// COZYLEEN FURNITURE - FIXED IMAGES
...
{id:24,name:'Cozyleen Shoe Rack Wooden',price:120000,cat:'furniture',img:'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400'},
{id:25,name:'Cozyleen 6 Seater Sofa Set',price:2550000,cat:'furniture',img:'https://images.unsplash.com/photo-1484101403633-562f891dc89a?w=400'}
];
let orders=[];
app.get('/api/products',(req,res)=>res.json(products));
app.get('/api/orders',(req,res)=>res.json(orders));
app.post('/api/orders',(req,res)=>{orders.push({...req.body,id:Date.now(),date:new Date()});res.json({ok:true})});
app.get('/',(req,res)=>res.send('BusyBags API - Fixed images'));
